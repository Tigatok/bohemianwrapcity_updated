(function ($) {
  ...
  Drupal.behaviors.bohemianwrapcity_custom_toolbar = {
  ...
  // on normal devices.
  Drupal.behaviors.bohemianwrapcity_custom_search_api_ranges = {
    attach:function (context, settings) {
  ...
  Drupal.behaviors.bohemianwrapcity_custom_search = {
    attach: function(context, settings) {
