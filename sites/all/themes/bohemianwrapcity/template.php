 ...
 * @see html.tpl.php
 */
function bohemianwrapcity_preprocess_html(&$variables) {
  ...
  drupal_add_library('bohemianwrapcity', 'selectnav');
}

/**
 * Implements hook_library().
 */
function bohemianwrapcity_library() {
 ...
 */
function bohemianwrapcity_preprocess_node(&$variables) {
